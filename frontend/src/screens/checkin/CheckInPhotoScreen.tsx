...
export default function CheckInPhotoScreen() {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#F7F3EE' }}>
      ...
      <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', padding: 24 }}>
        ...
        <Text style={{ fontSize: 28, fontWeight: '700', color: '#1A120A', marginBottom: 48 }}>Photo</Text>
        <TouchableOpacity
          onPress={() => navigation.navigate('CheckInNote')}
